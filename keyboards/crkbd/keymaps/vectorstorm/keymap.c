...
void oled_task_user(void) {
	if (is_keyboard_master()) {
		...
		/* oled_render_layer_state(); */
		/* char wpm_str[10]; */
		/* snprintf(wpm_str, 10, "WPM:%03d", get_current_wpm());  // edit the string to change wwhat shows up, edit %03d to change how many digits show up */
