...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAME] = LAYOUT_planck_grid(
            ...
            KC_HYPR  ,KC_LCTL,KC_LALT,KC_LGUI,LOWER,KC_SPACE,KC_NO,RAISE,KC_LEFT ,KC_DOWN,KC_UP    ,KC_RIGHT
            ),
    ...
    [_RAISE] = LAYOUT_planck_grid(
            ...
            _______  ,KC_F7  ,KC_F8  ,KC_F9  ,KC_F10 ,KC_F11 ,KC_F12,KC_NONUS_HASH,KC_NONUS_BSLASH    ,KC_PGUP          ,KC_PGDOWN      ,KC_ENTER ,
            _______  ,_______,_______,_______,_______,_______,KC_NO ,_______      ,KC_MEDIA_NEXT_TRACK,KC_AUDIO_VOL_DOWN,KC_AUDIO_VOL_UP,KC_MEDIA_PLAY_PAUSE
            ),
    ...
    [_ADJUST] = LAYOUT_planck_grid(
            QWERTY   , GAME  ,_______,_______,_______,_______,_______,_______,_______,_______,_______,COLEMAK,
            ...
            _______  ,_______,_______,_______,_______,_______,KC_NO  ,_______,_______,_______,_______,EPRM
            ),
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | Hypr | Esc  | Alt  | GUI  |Lower |Space |Space |Raise | Left | Down |  Up  |Right |
     * `-----------------------------------------------------------------------------------'
     */
    [_COLEMAK] = LAYOUT_planck_grid(
            ...
            KC_HYPR, KC_ESC, KC_LALT, KC_LGUI, LOWER, KC_SPC, KC_SPC, RAISE, KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT
            ),
};
